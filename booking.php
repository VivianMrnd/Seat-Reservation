...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/moviepicker.css" />
        ...
        <nav class="navbar navbar-expand-md  pt-md-2 mb-5">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
              <a class="nav-item nav-link active navitem" href="booking.php">Home <span class="sr-only">(current)</span></a>
              <a class="nav-item nav-link navitem" href="index.php">Sign out </a>
            </div>
          </div>
        </nav>
      </div>
